...
const styles = StyleSheet.create({
  ...
  addButton: {
    ...
    borderRadius: 8,
    ...Platform.select({
      web: { boxShadow: '0px 4px 12px rgba(17, 50, 212, 0.2)' },
      default: { elevation: 4 }
    })
  },
  addButtonText: {
  ...
  searchBox: {
    ...
    borderColor: colors.slate200,
    ...Platform.select({
      web: { boxShadow: '0px 2px 4px rgba(0,0,0,0.02)' },
      default: { elevation: 1 }
    })
  },
  searchInput: {
  ...
  modalContent: {
    ...
    borderRadius: 24,
    ...Platform.select({
      web: { boxShadow: '0px 20px 50px rgba(0,0,0,0.15)' },
  ...
  submitButton: {
    ...
    borderRadius: 12,
    ...Platform.select({
      web: { boxShadow: '0px 4px 12px rgba(17, 50, 212, 0.3)' },
      default: { elevation: 4 }
    })
  },
  submitButtonText: {
